...
exports.refreshTokenTransport = void 0;
/**
 ...
 */
const refreshTokenTransport = (_req, res, next) => {
    ...
    res.json = (body) => {
        ...
        if (typeof pending === 'string' && pending && body && typeof body === 'object' && !Array.isArray(body)) {
            return originalJson({ ...body, refreshToken: pending });
        }
        return originalJson(body);
    };
    next();
};
exports.refreshTokenTransport = refreshTokenTransport;
//# sourceMappingURL=refreshTransport.js.map