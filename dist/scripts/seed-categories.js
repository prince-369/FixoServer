...
const categories = [
    // ──────────────── 1. Electrician ────────────────
    {
        ...
        description: 'From a flickering light to full home wiring, our verified electricians handle every electrical need safely and quickly. All work follows proper safety standards and comes with a service guarantee.',
        priceStartsFrom: 149,
        order: 1,
        highlights: [
    ...
    // ──────────────── 2. Plumber ────────────────
    {
        ...
        description: 'From minor tap leaks to full bathroom plumbing, our verified plumbers deliver quick, clean and reliable solutions. All work uses quality fittings and comes with a service guarantee.',
        priceStartsFrom: 149,
        order: 2,
        highlights: [
    ...
    // ──────────────── 2. Carpenter ────────────────
    {
        ...
        description: 'Professional carpentry services for your home — from furniture assembly and repair to custom woodwork. Our carpenters are experienced, carry their own tools, and deliver neat, durable results.',
        priceStartsFrom: 199,
        order: 3,
        highlights: [
    ...
    // ──────────────── 3. AC Service & Repair ────────────────
    {
        ...
        description: 'Keep your home cool with professional AC services. Our trained technicians handle all brands and types — split, window, cassette. From routine servicing to gas refill and full installation, we ensure your AC runs at peak performance.',
        priceStartsFrom: 299,
        order: 4,
        highlights: [
    ...
    // ──────────────── 4. Painter ────────────────
    {
        ...
        description: 'Transform your home with professional painting services. Our verified painters handle everything from single wall touch-ups to full home painting. We use premium paints, ensure clean edges, and protect your furniture throughout the process.',
        priceStartsFrom: 999,
        order: 5,
        highlights: [
    ...
    // ──────────────── 5. Home Cleaning ────────────────
    {
        ...
        description: 'Professional home cleaning services to make every corner of your home sparkle. Our trained cleaners use eco-friendly products and professional-grade equipment for a thorough, hygienic clean.',
        priceStartsFrom: 499,
        order: 6,
        highlights: [
    ...
    // ──────────────── 6. Appliance Repair ────────────────
    {
        ...
        description: 'Don\'t replace — repair! Our skilled technicians fix washing machines, refrigerators, microwaves, geysers, and more. We service all major brands and use genuine spare parts for lasting results.',
        priceStartsFrom: 199,
        order: 7,
        highlights: [
    ...
    // ──────────────── 7. RO / Water Purifier ────────────────
    {
        ...
        description: 'Professional RO and water purifier services for all brands. From annual maintenance to filter changes and new installation, our technicians ensure your water is always pure and safe to drink.',
        priceStartsFrom: 199,
        order: 8,
        highlights: [
    ...
    // ──────────────── 8. CCTV & Security ────────────────
    {
        ...
        description: 'Professional CCTV camera installation, DVR/NVR setup, and security system services. Our technicians handle wired, wireless, and IP camera systems for homes, shops, and offices.',
        priceStartsFrom: 499,
        order: 9,
        highlights: [
    ...
    // ──────────────── 9. Bike Service ────────────────
    {
        ...
        description: 'Get your bike serviced at your doorstep! Our trained mechanics handle everything from basic servicing to brake repair and engine tuning. All popular bike brands covered.',
        priceStartsFrom: 299,
        order: 10,
        highlights: [
    ...
    // ──────────────── 10. 4 Wheeler Service ────────────────
    {
        ...
        description: 'Professional car service at your doorstep. From periodic maintenance to detailing and minor repairs, our trained mechanics keep your car running smooth without the hassle of garage visits.',
        priceStartsFrom: 499,
        order: 11,
        highlights: [
    ...
    // ──────────────── 11. Interior Design Consultation ────────────────
    {
        ...
        description: 'Get professional interior design advice for your home or office. Our designers help with space planning, color schemes, furniture selection, modular kitchen design, and complete home makeovers — all within your budget.',
        priceStartsFrom: 999,
        order: 12,
        highlights: [
    ...
    // ──────────────── 12. Welding & Fabrication ────────────────
    {
        ...
        description: 'Professional welding and fabrication services for your home. Our skilled welders handle gate repair, window grills, railing work, MS fabrication, and custom metalwork with precision and durability.',
        priceStartsFrom: 299,
        order: 13,
        highlights: [
    ...
    // ──────────────── 13. Computer / Laptop Repair ────────────────
    {
        ...
        description: 'Professional computer and laptop repair services at your doorstep. Our certified technicians fix hardware issues, software problems, virus removal, data recovery, and more for all brands.',
        priceStartsFrom: 199,
        order: 14,
        highlights: [
...
async function seed() {
    try {
        ...
        for (const cat of categories) {
            const { slug, ...data } = cat;
            const result = await Category_1.default.findOneAndUpdate({ slug }, { $set: { slug, ...data } }, { upsert: true, new: true });
