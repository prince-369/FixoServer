...
const couponRedemptionSchema = new mongoose_1.Schema({
    coupon: { type: mongoose_1.Schema.Types.ObjectId, ref: 'CouponCampaign', required: true },
...
exports.default = mongoose_1.default.model('CouponRedemption', couponRedemptionSchema);
