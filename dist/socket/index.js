...
const initializeSocket = (server) => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('ekyc:create-room', async ({ workerId, workerName, workerPhone }) => {
            ...
            Worker_1.default.updateOne({ _id: workerId }, { $inc: { videoKycCallAttempts: 1 }, $set: { lastVideoKycCallAt: new Date() } }).catch((err) => console.error('[eKYC] Failed to record call attempt:', err));
