...
export declare const sendDeactivateAccountOtp: (req: Request, res: Response) => Promise<void>;
export declare const confirmDeactivateAccount: (req: Request, res: Response) => Promise<void>;
export declare const getCategories: (_req: Request, res: Response) => Promise<void>;
export declare const getServiceAvailability: (req: Request, res: Response) => Promise<void>;
export declare const joinWaitlist: (req: Request, res: Response) => Promise<void>;
